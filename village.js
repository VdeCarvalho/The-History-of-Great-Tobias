window.TobiasVillage = (() => {
  ...
  const blocks = [
    ...
    [710,393,72,57],[916,391,70,55],[723,556,70,62],[929,550,66,64],
  ...
  return {width:4096,height:3072,background:'village.png',mask:'village_walkable.png',residents,blocks,posts,
    ...
    occluders:blocks.filter(([x,y])=>x!==344||y!==376).concat([[344,376,242,30],[344,376,22,193],[560,376,26,193],[344,527,242,42]]),
